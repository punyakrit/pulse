    ...
    <div>
      <div className=" relative">
        ...
        <div className="container mx-auto">
          <div className="flex flex-col items-center justify-center mt-20 lg:mt-28 gap-4">
            <div>
            ...
            <Button className="bg-lime-400 text-black rounded-full text-xl font-bold px-12 py-6 flex items-center gap-2 hover:bg-lime-500 cursor-pointer">
              Get Started
